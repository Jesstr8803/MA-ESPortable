...
- **States** (panel): **Boot** splash, **Connecting** to Music Assistant, **Charging** screen, **Settings** (scrollable list — name/brightness/sleep/sync/calibrate-remote/Wi-Fi/MA/OTA/about), **Setup mode** (SoftAP). Settings is also reachable via the gear in the Library header.
