...
| **Power** | Onboard charging (board's MX1.25 header). **Battery: off-the-shelf LiPo pouch, ~152555 (15×25×55 mm, ~2000 mAh)** with a JST/MX1.25 connector — fits *within* the touch board's 59.6×28.5 mm footprint (width ≤28.5 is the binding constraint; go thick for capacity). Carrier adds DW01A protection. ~10 h with screen-sleep + WiFi power-save + deep buffer. *(Confirm exact pack against a real listing.)* |
